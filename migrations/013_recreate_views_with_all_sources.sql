-- Migration: Recriar VIEWs unified com TODAS as 3 fontes
-- Data: 2026-01-30
-- Fontes: xxxfollow, clubeadulto, nsfw247 (tabelas models e videos)
...
SELECT 
    ...
    m.bio,
    m.gender,
    COALESCE(m.follower_count, 0) + COALESCE((SELECT COUNT(*) FROM follows WHERE model_source = 'nsfw247' AND model_id = m.id), 0) as follower_count,
    m.like_count,
    m.view_count,
    m.post_count,
    m.video_count,
